...
import StyleBuilder from '@versatiles/style/dist/style_builder/style_builder';
import type { StyleRules, StyleRulesOptions } from '@versatiles/style/dist/style_builder/types';
...
export default class PathsongsOpen extends StyleBuilder<PathsongsOpen> {
	...
	protected getStyleRules(options: StyleRulesOptions<PathsongsOpen>): StyleRules {
...
let styleBuilder = new PathsongsOpen();
let style = styleBuilder.build();
console.log(prettyStyleJSON(style));